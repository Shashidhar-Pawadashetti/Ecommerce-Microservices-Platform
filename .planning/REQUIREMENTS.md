...
- [x] **CAT-01**: Visitor can browse the product listing without logging in
- [x] **CAT-02**: Visitor can view a single product's detail page backed by `GET /catalog/products/{id}`
